...
class DeliverSumRepoComponent extends Component
{
    use WithPagination;
    ...
    public $columns=DeliverySummaryReport::CONS_COLUMNS;
    ...
    public function render()
    {
        ...
        return view('livewire.reports.deliver-sum-repo-component')->with('collections', $collections);
    }
