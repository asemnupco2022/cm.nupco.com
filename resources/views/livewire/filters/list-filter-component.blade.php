            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <button class="btn btn-sm btn-success float-right flat" data-toggle="modal" data-target="#select_table_to_create_filter"><i class="fas fa-plus"></i>  Create Filter</button>
                        </div>
                    </div>
                </div>
